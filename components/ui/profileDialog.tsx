...
export const ProfileDialog = ({
  ...
  return (
    ...
    >
      <div className="md:scale-100 scale-[80%] w-[500px] rounded-xl text-lg font-regular bg-theme-surface border-theme-border border p-6 text-white">
          ...
          <div className="flex gap-0 md:gap-4 items-center">
            <div className="cursor-pointer group relative ">
              <Image
                ...
                height={60}
                unoptimized
                className="rounded-[12px] w-[60px] h-[60px] border border-theme-border"
              />
              <div
            ...
            <div className="flex md:flex-row gap-0 flex-col flex-1 items-center md:gap-3">
              ...
              <button
                ...
                className="disabled:opacity-50 mt-1 md:mt-6 ease-in-out hover:brightness-110 py-2 px-12 md:px-4 rounded-[6px]"
              >
                Change Name
              </button>
            </div>
