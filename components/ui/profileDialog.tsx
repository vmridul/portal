      ...
      <div className="md:scale-100 scale-[80%] w-[500px] rounded-xl text-lg font-regular bg-[#05070d] border-[#313131] border p-6 text-white">
        ...
        <div className=" mt-3 flex flex-col gap-3 text-sm">
          ...
          <div className="relative flex flex-col gap-2">
            ...
            <div className="relative border-[#313131] bg-opacity-70 text-opacity-70 border-opacity-70 rounded-[8px] text-[#e3e3e3] bg-[#1b1b1b] py-1 px-3 w-full border flex justify-between items-center">
              <input
