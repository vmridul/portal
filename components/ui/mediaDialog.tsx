...
export const MediaDialog = ({
  ...
  const activeData =
    activeTab === "images" ? images : activeTab === "videos" ? videos : files;
  ...
  return (
    <>
      {selectedIndex !== null && (
        <div
          className="fixed inset-0 z-[9999] bg-black/95 transition-opacity flex items-center justify-center p-4 md:p-10"
      ...
      >
        ...
        >
          ...
          <div
            className={`z-[9999] w-full flex-1 overflow-y-auto ${activeTab === "files" ? "flex flex-col gap-2" : "grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 auto-rows-[120px]"}`}
          >
            {activeData.length === 0 ? (
