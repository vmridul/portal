...
export function LandingTopGradient() {
  return (
    <svg
    ...
    >
      ...
      <path
        d="M 0 200 Q 0 0 200 0 L 1240 0 Q 1440 0 1440 200 L 1440 520 C 1200 900 950 700 780 900 C 600 1050 360 950 200 800 C 100 720 40 650 0 520 Z"
