...
export function Privacy() {
  return (
    <section className="relative md:mt-32 text-white overflow-hidden">
      ...
      <div className="md:mt-20 mt-8 max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        {privacy.map((text, i) => (
          <motion.div
            key={i}
            ...
            viewport={{ once: true }}
            className="relative h-48 w-full md:w-82 bg-[#0a0a0d] shadow-[inset_0_0_40px_rgba(255,255,255,0.05)] rounded-3xl flex items-center justify-center text-center px-12"
          >
