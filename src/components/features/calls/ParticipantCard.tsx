...
import { MicOff02Icon, VideoOffIcon, ComputerScreenShareIcon, FullscreenIcon } from "@hugeicons/core-free-icons";
    ...
    >
      ...
      {!hasVideo && isScreenShare && (
        <div className="flex flex-col items-center justify-center gap-3 text-gray-400">
          <HugeiconsIcon icon={ComputerScreenShareIcon} className="w-12 h-12 opacity-50" />
