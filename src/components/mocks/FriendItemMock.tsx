...
export const FriendItemMock = ({ name = "Alex", avatar = "/assets/sq.png", status = "Active now", message, className }: { name?: string; avatar?: string; status?: string; message?: string; className?: string }) => (
