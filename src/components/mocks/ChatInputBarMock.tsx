...
export const ChatInputBarMock = ({
  ...
  <div
    className={`${className} flex flex-col z-[99] w-full md:max-w-[400px] min-w-[350px] relative px-2 md:px-3 py-1 md:py-3 rounded-xl transition-all duration-300 ease-in-out border ${
      accent
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center gap-2">
          <div
            className={`border py-2 px-2 rounded-[12px] text-white cursor-default ${
              accent
        ...
        <div
          className={`py-3 px-3 rounded-[12px] cursor-default ${
            accent ? "bg-theme-accent text-theme-text" : "bg-white text-black"
          }`}
        >
