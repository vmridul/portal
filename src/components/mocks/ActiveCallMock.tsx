...
import { CallEnd01Icon, MicOff02Icon, FullscreenIcon } from "@hugeicons/core-free-icons"
    ...
    <div className={`${className}`}>
        ...
        <div className="flex gap-2">
            <Button
                variant="other"
                size="md"
                className={`cursor-default pointer-events-none  flex-1 flex items-center justify-center gap-2 py-2 rounded-lg transition-colors ${isMuted ? "bg-red-500/20 text-red-400" : "bg-[#272727] text-white"
                    }`}
            >
